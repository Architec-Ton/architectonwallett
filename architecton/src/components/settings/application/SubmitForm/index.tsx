...
const SubmitForm = () => {
  ...
  const [formValues, setFormValues] =
    useState<InitialValuesType>(formInitialValues);
  ...
  const pasteButtonClickHandler: CallableFunction = useCallback(
  ...
  return (
    <fetcher.Form
      method="post"
      className="application-submit-form"
      ...
      <InputGroup label={t('application_submit_main_info_label')}>
        ...
        <FormInputContainer
          ...
          label={t('small_description_label')}
          value={formValues.smallDescription}
          required
        />
        <FormInputContainer
          name="fullDescription"
          label={t('full_description_label')}
      ...
      <InputGroup label={t('application_submit_socials_label')}>
        <FormInputSocial
          ...
          pasteHandler={pasteButtonClickHandler}
      ...
      <InputGroup
        label={t('application_submit_resources_label')}
        info={t('application_submit_resources_info')}>
        <FormInputContainer
          name="resources"
          label={t('resources_label')}
          value={formValues.resources}>
          <PasteButton
            value={t('paste_button')}
            onClick={onPast('resources')}
          />
        </FormInputContainer>
      </InputGroup>
      <InputGroup label={t('application_submit_video_label')} info={''}>
        <FormInputContainer
          name="videoAbout"
          label={t('video_about_label')}
          value={formValues.videoAbout}>
          <PasteButton
            value={t('paste_button')}
            onClick={onPast('videoAbout')}
          />
        </FormInputContainer>
      </InputGroup>
      <InputGroup label={t('application_submit_owner_label')}>
        <FormInputContainer
          name="projectOwner"
          label={t('project_owner_label')}
          value={formValues.projectOwner}
          required
        />
      </InputGroup>
      <InputGroup
        label={t('application_submit_terms_label')}
        hint={t('application_submit_terms_hint')}>
        <TermsButton />
        <FormInputContainer
          name="agriment"
          type="checkbox"
