...
export function loadBankDetail(slice: Slice) {
  ...
  return {
    $$type: 'BankDetail' as const,
    banks: _banks,
    updateDate: _updateDate,
    banksOfSec: _banksOfSec,
  };
}
...
const CrowdSalev2_getters: ABIGetter[] = [
  {
    ...
    returnType: { kind: 'simple', type: 'BankDetail', optional: true },
  },
  {
    name: 'Banks',
    arguments: [
